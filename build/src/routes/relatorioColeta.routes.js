...
const updateStatusSchema = zod_1.z.object({
    statusColeta: zod_1.z.enum(['PENDENTE', 'NAO_RETIRADO', 'RETIRADO'])
});
const resend = new resend_1.Resend('re_9JQCKXzv_3exf8ZCTogu1wSCdbg5DTGvN');
async function relatorioColeta(fastify) {
    fastify.put('/amontoado/:amontoadoId/status-coleta', async (req, res) => {
        const { amontoadoId } = req.params;
...
async function sendEmailNotification(email, nome, mensagem) {
    try {
